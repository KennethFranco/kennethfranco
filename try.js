		...
		<div class="container">
            ...
            <div class="row px-0">
                <div class="col-md-12 text12 pl-0">
                    ...
                    <input class="longInput form-control mb-2 form-control-sm border bg-white rounded-0 border-secondary" type="text" placeholder="Freshman" id="student_type" disabled value="Freshman"></input>
                    <label class="mb-0 p-0" for="acadDept">Academic Department<span class="text-red"> *</span></label>
                    // Put back id = "acadcDept" when demo is done
                    <select class="mb-2  text-gray col-md-12 border bg-white border-dark c-p-5" aria-label="Default select example">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3 ">
						...
						<select id="religion" class="text-gray p-1 col-12 border bg-white border-dark c-p-5">
							...
							<option value="Worladwide Church of God">Worldwide Church of God</option>
				...
				<div class="row">
						<div class="col-md-10 row">
							...
							<div class="col-md-3">
								...
								<p class="text-gray text12 p-0">${acad_department}</p>
							</div>
							<div class="col-md-3">
