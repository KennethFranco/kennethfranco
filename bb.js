// frappe.ready(function() {
	...
	$('.go_to_background').click( () => {
	    ...
	    // console.log(parentProvided)
	    
        if (first_name == "" || last_name == "" || middle_name == "" || gender == null || birthday == "" || mother_tongue == "" || ethnic == null || religion == null || mobile_number == "" || home_phone == "" || email == "" || barangay == null || city == null || province == null) {
            frappe.msgprint({
                title: __('Error'),
                indicator: 'green',
