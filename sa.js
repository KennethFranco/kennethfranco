// frappe.ready(function() {
	...
	$('.go_to_background').click( () => {
	    ...
	    if (first_name == "" || last_name == "" || middle_name == "" || gender == "" || birthday == "" || Age_as == "") {
            frappe.msgprint({
                title: __('Error'),
                indicator: 'green',
        ...
        if (first_name == "" || last_name == "" || middle_name == "" || gender == null || birthday == "" || mother_tongue == "" || ethnic == null || religion == null || mobile_number == "" || home_phone == "" || email == "" || barangay == null) {
            frappe.msgprint({
                title: __('Error'),
                indicator: 'green',
                message: __('Some required fields have not been filled up, please fill them up before submission.')
